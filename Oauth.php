...
define('CONSUMER_KEY', 'ftDFscmRFXUyvviTM9s6g');
define('CONSUMER_SECRET', 'Gx2lA0JLsoCmpG4GN4GI2bbivcuJ53u2hXBmpi0');
/**
...
//$json = search_for_a_term($bearer_token, "%23stanleycup", 'mixed', '5');
